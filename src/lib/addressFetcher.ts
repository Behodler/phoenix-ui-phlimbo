...
export async function fetchLocalAddresses(): Promise<ContractAddresses> {
  ...
  try {
    ...
    const addresses: ContractAddresses = {
      ...
      MultiPooler: data.MultiPooler || '0x0000000000000000000000000000000000000000',
      UniboostEYE: data.UniboostEYE || '0x0000000000000000000000000000000000000000',
      UniboostFLX: data.UniboostFLX || '0x0000000000000000000000000000000000000000',
      UniboostSCX: data.UniboostSCX || '0x0000000000000000000000000000000000000000',

      UniboostHookEYE: data.UniboostHookEYE || '0x0000000000000000000000000000000000000000',
      UniboostHookFLX: data.UniboostHookFLX || '0x0000000000000000000000000000000000000000',
      UniboostHookSCX: data.UniboostHookSCX || '0x0000000000000000000000000000000000000000',

      UniboostStakerEYE: data.UniboostStakerEYE || '0x0000000000000000000000000000000000000000',
      UniboostStakerFLX: data.UniboostStakerFLX || '0x0000000000000000000000000000000000000000',
      UniboostStakerSCX: data.UniboostStakerSCX || '0x0000000000000000000000000000000000000000',
      ...
      USDe: data.USDe || '0x0000000000000000000000000000000000000000',
      ...
      YieldStrategyDolaLegacy: data.YieldStrategyDolaLegacy || '0x0000000000000000000000000000000000000000',
      SDOLA: data.SDOLA || '0x0000000000000000000000000000000000000000',
    }
